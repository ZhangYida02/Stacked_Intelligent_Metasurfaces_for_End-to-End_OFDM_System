...
def get_args():
    ...
    parser.add_argument('--A_tx', default='25', type=int, help="Number of transmitting antennas.")
    parser.add_argument('--A_rx', default='9', type=int, help="Number of receiving antennas.")
    ...
    # parser.add_argument('--P_tx_dBm', default='70', type=int, help="Transmitted power(dBm).")
    ...
    folder_name = f"Unpolarized channel/{args['B']}MHz_{args['N_c']}Nc_{args['J']}UE_{args['epsilon']}ep_{args['M']}-{args['N']}"
    file_name = args['channel']
    args['channel_path'] = folder_name+"/"+file_name

    name = f"{args['B']}MHz_{args['N_c']}Nc_{args['J']}UE_{args['epsilon']}ep_{args['M']}-{args['N']}"
